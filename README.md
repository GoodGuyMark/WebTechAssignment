# Web Technologies Assignment 2019
...
6. To start the application, run the project on the newly created Wildfly server and go to http://localhost:8080/WebTechAssignmentV2/ on your browser.
